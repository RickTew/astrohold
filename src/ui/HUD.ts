        ...
        <div class="sp-inner">
          ...
          <details class="sp-howto">
            ...
            <div class="sp-howto-body">
              ...
              <p><strong>2026-07-13:</strong> AstroHold now has its own app icon: a letter-A spaceship. If you add the game to your phone's home screen it shows up like a real app, and the browser tab icon matches.</p>
              <p><strong>2026-07-08:</strong> ASTROCRAFT: Sphere Drones now really help construction. A building builds itself at normal speed, but each drone standing beside the site adds +50% build speed (up to double with two drones, shown as a green BUILD x2 tag), and helpers return to mining when it finishes. The mission text now also spells out that the FABRICATOR is where you train your attack units (Combat Dog, Marine, Heavy).</p>
              <p><strong>2026-07-08:</strong> ASTROCRAFT quality of life: hovering a button in the bottom-right command card now shows a tooltip explaining what it does, the info bar for a selected unit or building includes a description, and clicking the info bar no longer deselects your units.</p>
              <p><strong>2026-07-08:</strong> ASTROCRAFT major update: the Cyborg base now really mines and spends its credits on an army that marches on you, neutral purple SCAVENGER raiders periodically attack BOTH sides from the map edges, and golden SUPPLY DROPS land near the middle - stand a unit next to one to claim +150 credits before the enemy does. You can now pan the map by dragging with the middle mouse button or dragging on the minimap (edge scroll and wheel zoom still work). Plus a visual pass: starfield and nebula backdrop, spark explosions, screen shake, glowing tracers, muzzle flashes, and floating credit numbers.</p>
              ...
              <p><strong>Coming soon (faction looks):</strong> Human soldiers (Grenadier, Hulk, Sniper, Stalker, Hacker), Robot attacker units, and Cyborg + Human versions of the mobile units (Sphere, Dog, Repair). Defender towers stay shared. Until each piece ships its own art it uses the shared robot look.</p>
